...
import { useDeleteCategeory } from '@/hooks/useCategories';
...
const DeleteCategoryDialog = ({ trigger, categoryId }: Props) => {
            ...
            <DialogContent className="sm:max-w-md">
                <DialogHeader>
                    <DialogTitle className="flex items-center gap-2 text-xl">
                        ...
                        Eliminar Categoría con ID {categoryId}
                    </DialogTitle>
                    <DialogDescription className="py-4 text-base">
                        ¿Está seguro que desea eliminar esta categoría? Esta acción no se puede deshacer y todos los
